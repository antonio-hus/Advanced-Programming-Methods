...
public class RunExample extends Command {
    ...
    public void execute() {
        try{
            ...
            PrgState prg = new PrgState(new ExeStack(), symTableMyIStack, new OutList(), new FileTable(), new Heap(), new SemaphoreTable(), new LatchTable(), new LockTable(), new BarrierTable(), new ProcTable(), this.initialProgram);
