...
public interface IBarrierTable {
    ...
    void setContent(Map<Integer, Pair<Integer, MyIList<Integer>>> newContent);
    ...
    void put(Integer key, Pair<Integer, MyIList<Integer>> value) throws MyDictionaryException;
    ...
    Pair<Integer, MyIList<Integer>> update(Integer key, Pair<Integer, MyIList<Integer>> newValue) throws MyDictionaryException;
